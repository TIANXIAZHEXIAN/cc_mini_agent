...
Based on the user conversation above (EXCLUDING this note-taking instruction message as well as system prompt, cc_mini_agent.md entries, or any past session summaries), update the session notes file.
