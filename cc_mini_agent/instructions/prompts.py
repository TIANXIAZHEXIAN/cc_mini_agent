...
from cc_mini_agent.skill import Skill, discover_skills, format_skills_prompt
...
class PromptBuilder:
    ...
    def load_instructions(self, cwd: Optional[str] = None) -> "PromptBuilder":
        """Discover and load CC_MINI_AGENT.md instruction files / 发现并加载 CC_MINI_AGENT.md 指令文件

        Searches for CC_MINI_AGENT.md, .cc_mini_agent/CC_MINI_AGENT.md, .cc_mini_agent/rules/*.md, and
        CC_MINI_AGENT.local.md from CWD upward to root, plus ~/.cc_mini_agent/ for
    ...
    def build(self) -> str:
        ...
        Follows the exact order from getSystemPrompt() in prompts.ts:
          ...
          10. Language
          11. Memory & MCP
          12. CC_MINI_AGENT.md instructions
          13. Skills
        ...
        # CC_MINI_AGENT.md instructions (project / user / local)
