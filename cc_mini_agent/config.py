...
class Config:
    ...
    # --- Memory ---
    memory_dir: Optional[str] = None  # None = auto (~/.cc_mini_agent/memory/)
    ...
    # P2: also reads from CC_MINI_AGENT_LANGUAGE env var as fallback.
    language: Optional[str] = field(
        default_factory=lambda: os.environ.get("CC_MINI_AGENT_LANGUAGE")
    ...
    def effective_memory_dir(self) -> str:
        ...
        return os.path.join(os.path.expanduser("~"), ".cc_mini_agent", "memory")
    ...
    def effective_model(self) -> str:
        ...
        if self.model:
            return self.model
        from cc_mini_agent.providers.presets import PROVIDER_PRESETS
